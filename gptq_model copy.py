...
def load_model_tokenizer(model_path):
    ...
    model = AutoGPTQForCausalLM.from_pretrained(model_path, quantize_config=quantize_config,trust_remote_code=True,device_map={"": 0},)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--quant_path",
        type=str,
        default="/data0/zhangchongrui/model/W8A16_g128",
    )
    parser.add_argument(
        "-d",
        "--data_path",
