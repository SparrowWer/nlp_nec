...
MODEL="/data0/zhangchongrui/model/Qwen1.5_72B_models/Qwen1.5-72B-Chat" # Set the path if you do not want to load from huggingface directly
# ATTENTION: specify the path to your training data, which should be a json file consisting of a list of conversations.
# See the section for finetuning in README for more information.
DATA="/data0/zhangchongrui/project/RAG_instruction_105_Q.json"

DS_CONFIG_PATH="/data0/zhangchongrui/project/qwen1.5/ds_config_zero3.json"
USE_LORA=False
Q_LORA=False
function usage() {
    echo '
...
torchrun $DISTRIBUTED_ARGS /data0/zhangchongrui/project/qwen1.5/finetune_v2.py \
    --model_name_or_path $MODEL \
    --data_path $DATA \
    --bf16 True \
    --output_dir /data0/zhangchongrui/model/qlora_qant_72B_v1 \
    --num_train_epochs 5 \
