...
from transformers import Trainer, deepspeed,GPTQConfig,BitsAndBytesConfig
...
def train():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        # quantization_config=GPTQConfig(  #推测是加载大模型，直接对其量化
        #   bits=4, disable_exllama=True,
        # #   dataset='wikitext2'
        #   dataset="/data0/zhangchongrui/dataset/wikitext-2-raw-v1"
        #   )
